    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'Nombre':
          ...
          break;
        case 'Icono':
          result.icono = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
...
class _$CategoriasRecord extends CategoriasRecord {
  ...
  _$CategoriasRecord._({this.nombre, this.icono, this.ffRef}) : super._();
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, nombre.hashCode), icono.hashCode), ffRef.hashCode));
  }
...
class CategoriasRecordBuilder
  ...
  String? _icono;
  String? get icono => _$this._icono;
  set icono(String? icono) => _$this._icono = icono;
  ...
  _$CategoriasRecord _build() {
    final _$result = _$v ??
        new _$CategoriasRecord._(nombre: nombre, icono: icono, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
