...
import 'list_noticias_copy_model.dart';
export 'list_noticias_copy_model.dart';

class ListNoticiasCopyWidget extends StatefulWidget {
  const ListNoticiasCopyWidget({
    Key? key,
    this.searchTerm,
  }) : super(key: key);
  ...
  @override
  _ListNoticiasCopyWidgetState createState() => _ListNoticiasCopyWidgetState();
}

class _ListNoticiasCopyWidgetState extends State<ListNoticiasCopyWidget> {
  late ListNoticiasCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListNoticiasCopyModel());
